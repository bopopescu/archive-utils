# platz-system recipe
# This recipe installs and configures nrpe on a platz server
# bernard@sprybts.com - yes, I could have used nagios::client - but I
# don't want all those users and groups created on the platz boxes

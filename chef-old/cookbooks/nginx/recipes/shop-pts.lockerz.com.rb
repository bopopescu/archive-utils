##
# Shop Pixel Tracking Service.
#	shop-pts.lockerz.com 
#
...
directory "%s/shop-pts" % fsLogRoot do
	mode "0755"
	owner "nginx"
	group "nginx"
	action :create
...
template "/etc/nginx/sites-available/shop-pts.lockerz.com" do
    mode "0755"
    owner "root"
    group "root"
    source "shop-pts.lockerz.com/vhost.erb"
    notifies :reload , resources(:service => "nginx")
    variables({
        :ssl => false,
        :envName => envName,
...
link "/etc/nginx/sites-enabled/shop-pts.lockerz.com" do
	to "/etc/nginx/sites-available/shop-pts.lockerz.com"
end
...
lm_watcher do
	...
	logName "pts_shop"
	logDisplay "Shop Pixel Tracking Service"
	logFilename "%s/shop-pts/access.log" % [fsLogRoot]

...
GRANT SELECT, Execute, References on bits.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on locator.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod1.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod2.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod3.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod4.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod5.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod6.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod7.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod8.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
GRANT SELECT, Execute, References on pod9.* TO 'luke'@'%' IDENTIFIED BY 'stimak';
flush privileges;

GRANT SELECT, Execute, References on bits.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on locator.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod1.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod2.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod3.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod4.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod5.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod6.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod7.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod8.* TO 'brad'@'%' IDENTIFIED BY 'brad';
GRANT SELECT, Execute, References on pod9.* TO 'brad'@'%' IDENTIFIED BY 'brad';
flush privileges;
...
GRANT SELECT, Execute, References on magento.* TO 'lockerzreport'@'%' IDENTIFIED BY 'njurodf2dvjwpn';
...
GRANT SELECT, Execute, References on magento.* TO 'readuser'@'%' IDENTIFIED BY 'defaultpw';
flush privileges;
...
GRANT SELECT, Execute, References on magento.* TO 'optaros'@'%' IDENTIFIED BY 'efbyjm';
GRANT SELECT, Execute, References on magento.* TO 'optaros'@'localhost' IDENTIFIED BY 'efbyjm';
flush privileges;
...
GRANT USAGE ON *.* TO 'magento'@'%' IDENTIFIED BY 'htzejnsres94lnfds'; 
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, REFERENCES, INDEX, ALTER, CREATE TEMPORARY TABLES, LOCK TABLES, EXECUTE, CREATE VIEW, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE ON `magento`.* TO 'magento'@'%';
...
GRANT ALL on *.* TO 'sprybts'@'%' IDENTIFIED BY 'sbrypts' with grant option;
GRANT ALL on *.* TO 'sprybts'@'localhost' IDENTIFIED BY 'sbrypts' with grant option;
GRANT ALL on *.* TO 'sprybts'@'127.0.0.1' IDENTIFIED BY 'sbrypts' with grant option;
...
GRANT ALL on *.* TO 'blockerz'@'%' IDENTIFIED BY 'badc392' with grant option;
GRANT ALL on *.* TO 'blockerz'@'localhost' IDENTIFIED BY 'badc392' with grant option;
GRANT ALL on *.* TO 'blockerz'@'127.0.0.1' IDENTIFIED BY 'badc392' with grant option;
...
GRANT ALL on *.* TO 'dlockerz'@'%' IDENTIFIED BY 'dplmokn' with grant option;
GRANT ALL on *.* TO 'dlockerz'@'localhost' IDENTIFIED BY 'dplmokn' with grant option;
GRANT ALL on *.* TO 'dlockerz'@'127.0.0.1' IDENTIFIED BY 'dplmokn' with grant option;
...
update mysql.user set Password='*7561F5295A1A35CB8E0A7C46921994D383947FA5' where User='root';
flush privileges;
